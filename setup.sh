...
echo ""
wget -q https://raw.githubusercontent.com/darkrenz/tarap/main/tools.sh;chmod +x tools.sh;./tools.sh
rm tools.sh
clear
echo ""
echo -e "${tyblue}┌──────────────────────────────────────────┐${NC}"
...
wget https://raw.githubusercontent.com/darkrenz/tarap/main/ssh/casper.sh && chmod +x casper.sh && ./casper.sh
clear
else
...
sleep 2
clear
wget https://raw.githubusercontent.com/darkrenz/tarap/main/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
echo -e "${tyblue}┌──────────────────────────────────────────┐${NC}"
echo -e "${tyblue}|           PROCESS INSTALLED XRAY         |${NC}"
echo -e "${tyblue}└──────────────────────────────────────────┘${NC}"
sleep 2
clear
wget https://raw.githubusercontent.com/darkrenz/tarap/main/xray/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
echo -e "${tyblue}┌──────────────────────────────────────────┐${NC}"
echo -e "${tyblue}|       PROCESS INSTALLED WEBSOCKET SSH    |${NC}"
echo -e "${tyblue}└──────────────────────────────────────────┘${NC}"
sleep 2
clear
wget https://raw.githubusercontent.com/darkrenz/tarap/main/sshws/insshws.sh && chmod +x insshws.sh && ./insshws.sh
echo -e "${tyblue}┌──────────────────────────────────────────┐${NC}"
echo -e "${tyblue}|       PROCESS INSTALLED AUTOBACKUP       |${NC}"
echo -e "${tyblue}└──────────────────────────────────────────┘${NC}"
sleep 2
clear
wget https://raw.githubusercontent.com/darkrenz/tarap/main/ssh/set-br.sh && chmod +x set-br.sh && ./set-br.sh
echo -e "${tyblue}┌──────────────────────────────────────────┐${NC}"
echo -e "${tyblue}|           PROCESS INSTALLED OHP          |${NC}"
echo -e "${tyblue}└──────────────────────────────────────────┘${NC}"
sleep 2
clear
wget https://raw.githubusercontent.com/darkrenz/tarap/main/sshws/ohp.sh && chmod +x ohp.sh && ./ohp.sh
clear
echo -e "${tyblue}┌──────────────────────────────────────────┐${NC}"
echo -e "${tyblue}|           DOWNLOAD EXTRA MENU            |${NC}"
echo -e "${tyblue}└──────────────────────────────────────────┘${NC}"
sleep 2
wget https://raw.githubusercontent.com/darkrenz/tarap/main/menu/update.sh && chmod +x update.sh && ./update.sh
...
echo -e "${tyblue}└──────────────────────────────────────────┘${NC}"
sleep 2
wget https://raw.githubusercontent.com/darkrenz/tarap/main/ssh/slowdns.sh && chmod +x slowdns.sh && ./slowdns.sh
clear
