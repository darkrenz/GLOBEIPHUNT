...
NUMBER_OF_CLIENTS=$(grep -c -E "^#ss " "/etc/xray/config.json")
	if [[ ${NUMBER_OF_CLIENTS} == '0' ]]; then
		clear
        echo -e "$COLOR1━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
        echo -e "$COLOR1 ${NC} ${COLBG1}            ⇱ Renew Shadowsocks ⇲           ${NC} $COLOR1 $NC"
        echo -e "$COLOR1━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
		echo ""
...
sed -i "s/#ss $user $exp/#ss $user $exp4/g" /etc/xray/config.json
sed -i "s/#ssg $user $exp/#ssg $user $exp4/g" /etc/xray/config.json
